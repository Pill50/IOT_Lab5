...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"phucpill/feeds/iot-lab.cambien1", "phucpill/feeds/iot-lab.cambien2", "phucpill/feeds/iot-lab.nutnhan1", "phucpill/feeds/iot-lab.nutnhan2"};

    final String clientId = "12345678";
    final String username = "phucpill";
